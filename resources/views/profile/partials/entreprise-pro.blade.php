    ...
    <div class="max-w-4xl flex items-center flex-wrap mx-auto  lg:my-0 ">
        ...
        <div id="profile"
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <!-- <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
                    ...
                    <img src="{{asset('images/' . $user->entreprise->logo)}}" class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center">
        ...
        <div class="w-full lg:w-2/5">
            ...
            <img src="{{asset('images/' . $user->entreprise->logo)}}" class="rounded h-150 w-50 hidden lg:block">
