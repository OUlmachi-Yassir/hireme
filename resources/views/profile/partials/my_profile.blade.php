...
>
  ...
  <div class="headings *:text-center *:leading-4">
    <p class="text-xl font-serif font-semibold text-[#434955]">{{ $user->name }}</p>
    <p class="text-sm font-semibold text-[#434955]">{{ $user->profile->industry }}</p>
  </div>
  <div class="w-full items-center justify-center flex">
    ...
    >
      ...
      <li>
        ...
        <p>{{ $user->profile->contact_information }}</p>
      </li>
      <li>
        <svg
          class="fill-stone-700 group-hover:fill-[#58b0e0]"
